const CACHE='fuel-app-v5';
const ASSETS=['./','./index.html','./styles.css','./overrides.css','./app.js','./manifest.webmanifest','./icons/apple-touch-icon.png','./icons/icon-192.png','./icons/icon-512.png'];
